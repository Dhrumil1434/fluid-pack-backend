...
export enum ActionType {
  ...
  UPDATE_MACHINE_SEQUENCE = 'UPDATE_MACHINE_SEQUENCE',
  // QC document entry actions
  CREATE_QC_ENTRY = 'CREATE_QC_ENTRY',
  EDIT_QC_ENTRY = 'EDIT_QC_ENTRY',
  DELETE_QC_ENTRY = 'DELETE_QC_ENTRY',
  VIEW_QC_ENTRY = 'VIEW_QC_ENTRY',
  // QC approval actions
  CREATE_QC_APPROVAL = 'CREATE_QC_APPROVAL',
  EDIT_QC_APPROVAL = 'EDIT_QC_APPROVAL',
  DELETE_QC_APPROVAL = 'DELETE_QC_APPROVAL',
  VIEW_QC_APPROVAL = 'VIEW_QC_APPROVAL',
  APPROVE_QC_APPROVAL = 'APPROVE_QC_APPROVAL',
  ACTIVATE_MACHINE = 'ACTIVATE_MACHINE',
  // SO (Sales Order) actions
  CREATE_SO = 'CREATE_SO',
  EDIT_SO = 'EDIT_SO',
  UPDATE_SO = 'UPDATE_SO',
  DELETE_SO = 'DELETE_SO',
